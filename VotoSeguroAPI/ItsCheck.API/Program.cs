...
namespace ItsCheck.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Log.Information($"(DatabaseConnection) String de conexao com banco de dados para ItsCheck: \n{databaseItsCheck} \n");
            ...
            {
                x.UsePostgreSqlStorage(options => options.UseNpgsqlConnection(databaseItsCheck));
            });
